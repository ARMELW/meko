  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: cn('flex text-white', props.showWeekNumber && 'justify-end'),
        weekday: 'text-white rounded-md w-9 font-normal text-[0.8rem]',
        week: 'flex w-full mt-2 text-white',
        ...
        day_button: cn(
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-l-md rounded-r-md text-white hover:text-white',
        ),
        range_end: 'day-range-end',
        selected:
          'bg-[#006EB6] text-white hover:bg-[#006EB6] hover:text-white focus:bg-[#006EB6] focus:text-white rounded-l-md rounded-r-md',
        today: 'bg-[#006EB6]/50 text-white',
        outside:
        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger className="focus:bg-[#006EB6] focus:text-white w-fit gap-1 border-none p-0 text-white">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="z-[9999] bg-[#0040B6] border border-[#006EB6] text-white">
                  {MONTHS.map((month) => (
                    <SelectItem key={month.value} value={month.value.toString()} className="hover:bg-[#006EB6] focus:bg-[#006EB6]">
                      {month.label}
                    </SelectItem>
                  ))}
                </SelectContent>
              ...
              >
                ...
                <SelectContent className="z-[9999] bg-[#0040B6] border border-[#006EB6] text-white">
                  {YEARS.map((year) => (
                    <SelectItem key={year.value} value={year.value.toString()} className="hover:bg-[#006EB6] focus:bg-[#006EB6]">
                      {year.label}
                    </SelectItem>
                  ))}
                </SelectContent>
...
const DateTimePicker = React.forwardRef<Partial<DateTimePickerRef>, DateTimePickerProps>(
  (
    ...
    // Synchroniser la locale avec i18n
    const locale = React.useMemo(() => {
      // On utilise la locale complète pour le formatage
