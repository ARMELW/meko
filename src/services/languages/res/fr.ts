const fr = {
	modules: {
		...
		progress: {
			unlockableGames: "Jeux à débloquer",
	...
	childSessionMonitor: {
		...
		noChildConnected: "Aucun enfant connecté",
		childProfile: "Profil enfant connecté",
		dashboardTitle: "Tableau de bord de {{name}}",
		finishedGames: "Nombre de jeux terminés",
		inProgressGames: "Nombre de jeux en cours",
	...
	auth: {
		otpTitle: "CODE À 6 CHIFFRES",
		otpInstruction: "Veuillez saisir le code envoyé à votre adresse email",
		validate: "Valider",
		login: 'Connexion',
	...
	subscription: {
		...
		invoiceHistory: {
			...
			monthly: "Mensuel",
			view: "Voir",
			downloadInvoice: "Télécharger la facture {{id}}",
			noInvoices: "Aucune facture trouvée.",
			trialOngoing: "Votre essai gratuit est en cours. Pas encore de facture."
		}
	},
};
